...
- (void)HTTPRequester:(HTTPRequester *)requester didFinishedWithResult:(id)result
{
    ...
    result = [CodeUtils encodeAllChinese:result];
//    NSLog(@"encode chinese used:%fs", [NSDate timeIntervalSinceReferenceDate] - startTime);
    result = [[LuaHelper sharedInstance] invokeMethodWithName:@"filterDictionaryResult" 
                                                  paramValue:result];
    startTime = [NSDate timeIntervalSinceReferenceDate];
    result = [CodeUtils decodeAllChinese:result];
//    NSLog(@"decode chinese used:%fs", [NSDate timeIntervalSinceReferenceDate] - startTime);
